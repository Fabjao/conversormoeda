...
const request = "https://api.hgbrasil.com/finance?format=json&key=e11bef65";
...
class _HomeState extends State<Home> {
  ...
  void _bitCoinChange(String text) {
    ...
    realController.text = (coin * bitcoin).toStringAsFixed(2);
    dolarController.text = (coin * bitcoin / dolar).toStringAsFixed(2);
    euroController.text = (coin * bitcoin / euro).toStringAsFixed(2);
  }
                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Divider(),
                      buildTextField(
                          "Bit Coin", "₿", bitCoinController, _bitCoinChange),
                    ],
                  ),
                );
              }
...
Widget buildTextField(String label, String prefix,
    TextEditingController tipoController, Function func) {
  return TextField(
    onChanged: func,
